...
│
├── Data/                       # ⚠ Not tracked — place data here
...
```
Data/
  Totalsegmentator_dataset_v201.zip   # raw CT dataset
  segmentations.zip                   # generated by Segmentation step
  Dataset_Reviewed/
    reviewed_all.csv                  # columns: patient_id, gender, voxel_count
    reviewed_male.csv
    reviewed_female.csv
```
...
Per-file AI contribution estimates are listed in the Module Summary tables above and documented in full in `docs/AI_Use_Disclosure.md`. The research paper used Grammarly for grammar and Claude for reference formatting and outline assistance.
